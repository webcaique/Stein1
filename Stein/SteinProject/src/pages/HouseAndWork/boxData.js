...
export default function(props) {
    ...
    const Deletar = async(idParaDeletar)=>{
        ...
        deletar.doc(props.localID).delete().then(()=>{
                ...
                <View style={styles.line}>
                    ...
                    <View style={styles.link}>
                        ...
                        <View style={styles.iconLinkView}>
                            <Image
                                source={{ uri: "https://firebasestorage.googleapis.com/v0/b/stein-182fa.appspot.com/o/Icons%2Fpin-de-localizacao.png?alt=media&token=c10be2a4-3f24-46f6-8368-7d40016bbe48" }}
